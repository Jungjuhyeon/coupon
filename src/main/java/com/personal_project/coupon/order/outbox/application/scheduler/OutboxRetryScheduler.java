package com.personal_project.coupon.order.outbox.application.scheduler;

import com.personal_project.coupon.order.outbox.application.inputport.OrderOutboxPublisher;
